...
export const GamePage = () => {
  ...
  const finishGame = () => {
    ...
    setTimeout(() => {
      navigate(`/end?points=${points}&answered=${questionsAnswered}&correctly=${questionsAnsweredCorrectly}`);
    }, 50);
  }
          ...
          { 
            ...
            <span
              ...
              className={`
                ...
                w-full sm:w-max transparent hover:shadow-[0_0_0_4px_rgb(var(--color-primary-1200)/.5)]
