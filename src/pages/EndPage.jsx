...
export const EndPage = () => {
  ...
  return (
    <div className="text-center ">
      <p className="text-4xl py-8">{message}</p>
      <p className="flex items-center justify-center gap-4 text-4xl py-8">Points: {points} <i className="fa-solid fa-coins"></i> </p>
      <p className="text-xl pb-2">You answered correctly {correctly}</p>
      <p className="text-xl pb-8">Total questions { answered > 1 ? 'were' : 'was' } {answered}</p>
